...
class ConfirmationLinkProtectorAdapter implements ConfirmationLinkProtector {
    ...
    ConfirmationLinkProtectorAdapter(@Value("${app.jwt.secret}") String secret) {
        try {
            ...
            throw new IllegalStateException("Unable to initialize confirmation link protection", exception);
        }
    }
    ...
    public String protect(String confirmationLink) {
        try {
            ...
            throw new IllegalStateException("Unable to protect confirmation link", exception);
        }
    }
    ...
    public String unprotect(String protectedLink) {
        try {
            ...
            throw new IllegalStateException("Unable to unprotect confirmation link", exception);
        }
    }
}
